...
read_chunk("./content/post/2020-03-27-florida-demographic-growth/fl-demo-growth.R") # path from the root to the R script.
# read_chunk("../../../content/post/2020-03-27-florida-demographic-growth/fl-demo-growth.R") # path from the root to the R script. 
```
# Abstract
...
See the report in its native environment of [suicide-prevention-2019](https://github.com/dss-hmi/suicide-prevention-2019) repository [here](https://raw.githack.com/dss-hmi/suicide-prevention-2019/3ff78365931214e342640523f2096c2eac443b2f/analysis/blogposts/florida-demographic-growth/fl-demo-growth.html)
...
![View of the reporting tool](data/FloridaPopulation-2006-2020.PNG)
...
![View of the extracted data](data/extracted-data.PNG)
...
```{r save-to-disk}
```
The cleaned version of this dataset is available for download [here](https://github.com/dss-hmi/suicide-prevention-2019/raw/3ff78365931214e342640523f2096c2eac443b2f/analysis/blogposts/florida-demographic-growth/data/clean_data.rds).
