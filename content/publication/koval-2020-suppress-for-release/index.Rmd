---
title: Using Reproducible Data Visualisations to Augment Decision-Making During Suppression of Small Counts
subtitle: 
author:
- admin
- Anthony Leamon
...
image: 
  ...
  preview_only: no
projects: [HSIF]
publication: 'International Population Data Linkage Network Conference'
publication_short: "IPDLN"
publication_types:
- "1"


summary: Demonstrates using reproducible data visualisations for augmenting redaction decisions during small cell supression and creating documentaion transparent for non-technical audit.

abstract: When reporting disease rates to the public, a health system must take precaution to protect released data from re-identification risks. While specific guidelines and methods vary across data systems and governances, redaction of cells with small values is a key component in any approach for preparing data for public release. However, this process often faces challanges of human error during evaluating threats for re-calculation of redacted values from related cells. Instead of employing a complex generalizable solution, we make a case for organizing the procedure for small cell redaction as a data visualization task, allowing for straightforward quality control of suppression decision and thus more approachable to a non-technical audience.
...
url_poster: ""
url_project: ""
url_slides: "koval-2020-suppress-for-release.pdf"
url_source: "https://ijpds.org/article/view/1540"
url_video: ""


---

Paper presented at the [2020 conference of the 'International Population Data Linkage Network Conference](https://www.cahspr.ca/en/conferences), Adelaide, Australia. November 2020. ([Link](https://ijpds.org/article/view/1540))
